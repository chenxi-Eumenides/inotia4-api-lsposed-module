...
| 未开始 | 游戏机制的深入探索 | 数值公式未逆向（网络资料已有精确参照，见 game-systems §6） | 第一梯队：伤害公式（×1.2/0.66/0.5 常量、取整）/经验成长曲线/强化混沌（±50%/±100%）/宝石上限（6.1/11.1/17）/掉落权重表（千分比）；突破口：布甲 12% 魔攻加成规则（社区未解） | game-systems §6（P0#4 网络资料） |
