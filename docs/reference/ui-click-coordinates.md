...
| 元素 | 坐标 | 前提 | 说明/效果 | 截图 |
|---|---|---|---|---|
| Sound 开 | (1748, 288) | 主菜单环境设置面板 | 音量=6（APPINFO+0x00） | 无 |
| Sound 关 | (2352, 288) | 主菜单环境设置面板 | 音量=0 | 无 |
| Light Effect 开 | (1669, 576) | 主菜单环境设置面板 | 画质掩码 bit1 置位（5→7） | 无 |
| Light Effect 关 | (2219, 536) | 主菜单环境设置面板 | 画质掩码 bit1 清位（7→5） | 无 |
| Data Backup 保存 | (1748, 713) | 主菜单环境设置面板 | Hive 云存档合并链（非 SAVE_Save） | 无 |
| Data Backup 载入 | (2352, 713) | 主菜单环境设置面板 | 云存档检查 | 无 |
| Language 左箭头 | (1625, 995) | 主菜单环境设置面板 | 语言 UI 索引 -1（取模 5） | 无 |
| Language 右箭头 | (2355, 995) | 主菜单环境设置面板 | 语言 UI 索引 +1（取模 5） | 无 |