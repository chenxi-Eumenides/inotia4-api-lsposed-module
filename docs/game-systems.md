...
> 来源：`~/Documents/Install/Android/Game/艾诺迪亚4_盗版大修_v1.3.2_20260704/` 下 `说明20260704.jpg` + `附件20260704_v4.2.jpg`（改版作者修改介绍）。**本版为盗版大修 20260704，以下修改相对原版 v1.3.2**，逆向验证机制时须对照（数值/机制与 wiki 原版资料可能不一致）。
