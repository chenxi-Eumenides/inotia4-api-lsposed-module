...
| `/api/character/combat/{role}/cast_skill` | `CHAR_GetEnemyTarget`(0xe42b4) + `CHAR_SetActionID`(0xe79ec) | v0.4.12 | ✅ 真机（第 3 次成功） |
...
- `POST /api/character/combat/{role}/cast_skill` body `{"action_id":N}`（技能等级在链表节点内，无需传）
