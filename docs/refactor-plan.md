...
| **Config 收边** | nativeSetStackLimitEnabled/nativeSetTilesData 两处直调收口到 `service/ConfigApiService.kt`（applyToNative）；ConfigController 与 ApiServer 启动期统一调用；config/list、set 增加 opEnabled |
