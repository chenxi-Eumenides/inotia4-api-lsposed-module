...
CharMakeDefaultAttackFn fn_char_make_default_attack = nullptr;
...
bool bridge_init() {
    ...
    fn_char_make_default_attack = reinterpret_cast<CharMakeDefaultAttackFn>(g_base + F_CHAR_MAKE_DEFAULT_ATTACK_VMA);
