...
bool bridge_init() {
    ...
    fn_get_cumulate_count = reinterpret_cast<GetCumulateCountFn>(g_base + F_GET_CUMULATE_COUNT_VMA);
    ...
    fn_set_stat_base = reinterpret_cast<SetStatBaseFn>(g_base + F_SET_STAT_BASE_VMA);
    fn_status_dice_roll = reinterpret_cast<RollStatusDiceFn>(g_base + F_STATUSDICE_ROLL_VMA);
    ...
    fn_enchant_item = reinterpret_cast<EnchantItemFn>(g_base + F_ENCHANT_ITEM_VMA);
    fn_is_enchant_scroll = reinterpret_cast<IsEnchantScrollFn>(g_base + F_IS_ENCHANT_SCROLL_VMA);
    ...
    fn_state_set = reinterpret_cast<StateSetFn>(g_base + F_STATE_SET_VMA);
    fn_game_exit_save_slot_select_char = reinterpret_cast<GameExitSaveSlotSelectCharFn>(g_base + F_GAME_EXIT_SAVE_SLOT_SELECT_CHAR_VMA);
    fn_select_character_start_game = reinterpret_cast<SelectCharacterStartGameFn>(g_base + F_SELECT_CHARACTER_START_GAME_VMA);
    fn_tutorial_start = reinterpret_cast<TutorialStartFn>(g_base + F_TUTORIAL_START_VMA);
    fn_save_get_save_file_name = reinterpret_cast<SaveGetSaveFileNameFn>(g_base + F_SAVE_GET_SAVE_FILE_NAME_VMA);
    fn_cs_fs_remove = reinterpret_cast<CsFsRemoveFn>(g_base + F_CS_FS_REMOVE_VMA);
